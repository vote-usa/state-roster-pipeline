...
public class WyCandidateMapperTests
{
    ...
    public void ToCandidateRow_StatewideOffice_NoDistrict()
    {
        ...
        var candidate = WyCandidateMapper.ToCandidateRow(row, GeneralElection(), "https://example.com/candidates.csv");
    ...
    public void ToCandidateRow_PrimaryOfficeWithPartySuffix_StripsSuffix()
    {
        ...
        var candidate = WyCandidateMapper.ToCandidateRow(row, PrimaryElection(), "https://example.com/candidates.csv");
